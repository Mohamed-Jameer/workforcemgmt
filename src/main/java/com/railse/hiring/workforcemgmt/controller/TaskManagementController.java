...
public class TaskManagementController {
    ...
    public Response<Void> updatePriority(@PathVariable Long id, @RequestBody PriorityUpdateRequest request) {
        taskManagementService.updatePriority(id, request.getPriority());
    ...
    public Response<Void> addComment(@PathVariable Long id, @RequestBody TaskCommentRequest request) {
        taskManagementService.addComment(id, request);
        return new Response<>((Void) null);
    }
}
